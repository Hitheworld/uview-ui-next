<template>
	<view
      ...
      'u-col-center': props.center,
      'u-cell--required': props.required
    }"
		hover-stay-time="150"
...
<script setup lang="ts">
  ...
  const props = withDefaults(defineProps<UCellItemProps>(),  {
    // 左侧图标名称(只能uView内置图标)，或者图标src
    icon: '',
    // 左侧标题
    title: '',

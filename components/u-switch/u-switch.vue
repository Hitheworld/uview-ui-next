<template>
	<view
      class="u-switch"
      :class="[
          props.modelValue == true ? 'u-switch--on' : '',
          props.disabled ? 'u-switch--disabled' : ''
      ]"
      @tap="onClick"
      :style="[switchStyle]"
  >
...
<script setup lang="ts">
  import { CSSProperties, computed, nextTick, withDefaults} from "vue";
  ...
  const emit = defineEmits<{
    ...
    (e: 'change', modelValue: boolean, activeValue: number | string | boolean, inactiveValue: number | string | boolean): void;
  }>();

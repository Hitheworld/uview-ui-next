...
interface IRequestConfig {
	...
	complete: (response: IRequestResponse) => Promise<unknown>;
}
...
class Request {
	...
	private interceptor: IRequestInterceptor;
	private options: IRequestOptions | any;
	private delete: (url: string, data?: {}, header?: {}) => Promise<unknown>;
	private get: (url: string, data?: {}, header?: {}) => Promise<unknown>;
	private post: (url: string, data?: {}, header?: {}) => Promise<unknown>;
	private put: (url: string, data?: {}, header?: {}) => Promise<unknown>;

	setConfig(customConfig: IRequestConfig) {
